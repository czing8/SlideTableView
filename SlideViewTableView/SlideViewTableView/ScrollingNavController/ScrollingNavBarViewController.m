...
//  CeShi
//
//  Created by Vols on 14-7-10.
//  Copyright (c) 2014年 jianguo. All rights reserved.
//

#import "ScrollingNavBarViewController.h"

@interface ScrollingNavBarViewController () <UIGestureRecognizerDelegate>
...
- (void)followScrollView:(UIView*)scrollableView WithBgView:(UIView *)bgView
{
...
//	self.scrollableView.layer.frame = frame;
  ...
  self.scrollableView.backgroundColor = [UIColor blueColor];
  
  //    添加修改title方法
  self.navigationController.navigationBar.titleTextAttributes = @{NSForegroundColorAttributeName: [[UIColor grayColor] colorWithAlphaComponent:alpha], NSFontAttributeName: [UIFont boldSystemFontOfSize:18]};
}
